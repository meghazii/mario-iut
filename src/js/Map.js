class Map{
	...
	for(i = 0;i < this.widthMapA;i++){
		...
		if(i <47 && i > 43 || i > 60 && i < 69 || i >= 93 && i <= 96){
	...
	for(i = 0; i < 4;i++){
		...
		// this.tiles[i+26][this.heightMapA - 2] = new Entity(32,32,"./data/img/escalier.png", true);
		 this.tiles[i+35][this.heightMapA - 6] = new Entity(32,32,"./data/img/box.png", true);
		 this.tiles[i+57][this.heightMapA - 6] = new Entity(32,32,"./data/img/escalier.png", true); //mobs en dessous
		 this.tiles[i+70][this.heightMapA - 6] = new Entity(32,32,"./data/img/escalier.png", true); //mobs en dessous
	}
	for(i = 0; i < 3;i++){
		 ...
		 this.tiles[i+52][this.heightMapA - 4] = new Entity(32,32,"./data/img/escalier.png", true); // mobs en dessous
		 this.tiles[i+83][this.heightMapA - 6] = new Entity(32,32,"./data/img/box.png", true);
	}
	for(i = 0; i < 2;i++){
		 ...
		 this.tiles[i+88][this.heightMapA - 6] = new Entity(32,32,"./data/img/box.png", true);
	}
